  ...
  return (
    <AppShell>
      <SectionHeader
        ...
        subtitle="Upload your labeled dataset — the backend trains XGBoost, LightGBM and CatBoost and picks the best ensemble automatically. Typical time: 2–5 minutes."
      />
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            {done && !trainError && (
              <div className="flex gap-2">
                <a href="/insights"><Btn variant="secondary">Compare models</Btn></a>
                <a href="/score"><Btn>Score an account →</Btn></a>
              </div>
            )}
          </div>
